...
uses
  ...
  // cromis units
  Cromis.Comm.Custom, Cromis.Comm.IMC, Cromis.Threading.TS, Cromis.AnyValue;
...
begin
  ...
  FIMCServer.Filters.AddFilter(ZLIBFilter);
  FIMCServer.Filters.AddFilter(XTEAFilter('EncryptionKey'));
end;
